...
<div class="navbar">
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
   ...
   <a href="LoggedCatsPage.php"><i class="fas fa-cat"></i>Cats</a>
   <a class="active" href="LoggedOttersPage.php"><i class="fas fa-otter"></i>Otters</a>
...
<table class="table table-bordered">  
                ...
                <?php  
                $query = "SELECT * FROM pets WHERE `type`=3 ORDER BY id DESC";  
